...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MusicDownloadButton.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Rafael Costa/MusicDownloadButton'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Rafael Costa' => 'rafael@rafaelcosta.me' }
  s.source           = { :git => 'https://github.com/Rafael Costa/MusicDownloadButton.git', :tag => s.version.to_s }
